...
export const contentTypes = [
  {
    ...
    description: "Write posts and control how your blog appears on the site.",
...
export const pageDesigns = [
  ...
  },
  {
    id: "blog-list",
    slug: "blog",
    name: "Blog listing design",
    shortName: "Blog listing",
    type: "Page Design",
    contentTypeId: "posts",
    provider: "WordPress",
    status: "active",
    ...
    layoutKind: "listing",
    actionLabel: "Edit",
    description: "Change how your list of posts looks.",
    scopeNotice: "Changes apply to your list of posts.",
    previewLabel: "Blog listing",
  },
  {
    id: "blog-single",
    ...
    layoutKind: "single",
    actionLabel: "Edit",
    description: "Change how individual blog posts look.",
    scopeNotice: "Changes apply to all blog posts.",
    previewLabel: "Blog post",
  },
  {
    id: "product-list",
    slug: "shop",
